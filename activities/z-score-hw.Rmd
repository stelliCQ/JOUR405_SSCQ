...
I would draw the lines at value 16 and value 6. The pattern I see is that the majority of the calss tend to be within the range of 5 and 15. 
...
In the context of my previous answer, there was a significant difference because visually I estimated that it was 16 and 6. It differs by a lot since it wasn't as specific with the actual unusual amount starts with 11, and 7.
...
The day with the highest number of 911 overdose calls in Baltimore County was in October 4, 2022. X City News was able to find this by figuring out the days that were farthest from the average.  
...
A potential angle for reporting this is to figure out if a new wave of fentanyl-laced drugs, or a new drug entered the Baltimore County market during that time. My next step would be to check police reports that attended the 911 calls during the specified time period, and also check autopsy reports, if possible. I would talk to non-profit and non-governmental organizations that work with drug addiction about it. 

I would tell my editor that it's important to figure out if the spike in overdoses during that season or month is related to a new strain of fentanyl or a new deadlier drug concoction that can cause an even bigger crisis in Md. 
