...
```{r}
team_aces <- matches |> group_by(team) |>
...
team_aces <- team_aces |> mutate(percentile = ntile(total_aces, 100))
...
Maryland Women's Volleyball performed 95% better than the rest of the teams in the NCAA in service aces. In comparison, the University of Pennsylvania State University performs 87% better than
the rest of the NCAA division. 
