...
Yes, there's a difference with the latter. We see less 3,5 star rating than expected, and we saw an increase for 1 star, 2 stars, and 4 stars. 
...
Yes, we can reject the null hypothesis because the right-tail critical value is smaller than the chi-square value that we found. This means that because the critical value represents the possibility of the chi-square value is actually an extreme number, and the result isn't an extreme number. We can reject the null hypothesis.
