...
The differences between these 3 types of institutions shows that private schools have the highest
scores, then the public and finally the community institutions. There are scores that overlap
within each of the 3 groups, but the minium, max, mean and median are very different. Interesting enough,
both public and private universities have the same max of 1600. 
...
Yes, there's a significant difference in SAT scores across college types 
as sen in the very high F-value score. 

2. Which specific college types differ from each other?

All 3 differ from each other but the college types that really vary are private vs. community and
public v. community. 

3. How large are these differences?

For private v. community the difference is 366.96 higher for private than community.(huge differences)
For public v. community, the difference is 292.55 higher for public than community (huge differences)
For private v. public, the differnce is that public SAT scores are 74.40 points lower than public schools
...
Headline: Almost 300 point gap between community colleges and universities

Lede: An analysis of SAT scores of students in public universities, private universities and
community colleges show an almost 300 point gap for community college students compared to students admitted into universities. 

The average SAT score for community college students was 1068, compared to the 1435 for private institutions and 1360 for public institutions. 
