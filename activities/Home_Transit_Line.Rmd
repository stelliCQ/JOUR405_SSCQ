...
Local officials have claimed that the property value increase in X neighborhood is due to the new light rail line. 
X News analysis cannot confirm that the increase in home prices are directly related to the new rail line, but an 
increase in property value has occurred. 

Home prices have increased by $19,500 in X neighborhood, where the new rail line has been constructed.
Before, the opening of the line, homes were sold for an average of $285,000, but now its being sold 
for $304,000 on average. 
