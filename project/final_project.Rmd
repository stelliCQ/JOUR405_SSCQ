...
- There are 394 outliers from individual schools and 71 are extreme outliers. 
...
DEREK SUGGESTION! 
This is good stuff, and your z-scores work in particular are leading you to some excellent ideas. My suggestions:

Regression - you've got chronic absentee percentage and can do see to what extend you can predict that using other variables like attend_rate_pct.
ANOVA - you can do an ANOVA test using the chronic absentee pct and school type, but you want to use an average instead of each absentee pct. So you'd do something like this:
https://gist.github.com/dwillis/f0131c4b0709322dad6b5d49d54280d0
and then use the avg_chronic_absent in your ANOVA test and follow up with a TukeyHSD test to see the differences between school types. (DOING THIS!)
...
High schools have on average 11.86 percentage points higher chronic absenteeism than elementary schools. This is statistically significant.

Middle schools also have higher chronic absenteeism than elementary schools — by about 5.14 percentage points.

**This pattern is statistically significant across all pairwise comparisons. I have solid evidence that chronic absenteeism increases with school level.** AKA older students skip instead of it being that elementatry school kids don't go to school bc parents cant take them there or something. 
