...
One anomaly is that the highest number of accidents in the recorded data was in 2021 with almost 60. Another anomaly was that the lowest number of accidents was also in 2021 with it nearing 0. These two anomalies can be combined into one story angle, because it's interesting that in the same year we have the highest and lowest number of accidents.   
...
The days that have the highest average is Friday and Saturday. The days that have lowest average are Monday, Tuesday and Wednesday. These patterns exist because there are probably more people outside in the weekends driving than during the weekdays, since people are probably at work or at school.
...
I picked the date of October 29, 2021 that had the highest total of accidents in the data set. That day former Gov. Hogan declared a state of emergency for areas that included this county because of the worst flooding event that the state has seen in a decades.

I would incorporate this information to explain to readers why this day specifically had such a high number of accidents compared to the rest of the dataset.  

Link:https://wtop.com/weather-news/2021/10/powerful-storm-system-brings-heavy-rain-flooding-to-dc-area/
...
The overall z-scores highlighted days that are unusual from the dataset, regardless of the day of the week. It shows the outliers individually. Ex. Oct 29,2021 and May 5, 2021 had accidents higher than the mean, making it an extreme outlier.

Day-of-week scores show the days of the week that are unsually compared to other days of the week. So it means that Monday is only judged compared to other Mondays. 

With DOW, Sunday, Monday and Tuesday have the largest number of unusual days compared to their average. 

Using these two approaches can help us distinguish between one-off spikes in the data set and actual patterns in accidents. This helps journalism clear out the noise that can come from the data.
...
The months that have the highest average number of accidents are October, November, December and May. The months with the lowest average daily accidents per month are January, February and March.

My theory is that these months have high accidents due to changes in weather with rain and snow contributing to more accidents. Maryland weather tends to become more bipolar during the fall and spring months (with rain increasing).Another possibility is the increase in traffic during the times leading up to the holidays. 

The low accidents months are probably due to the winter weather probably discouraging people from getting into their cars and driving, which lowers the possibility of an accident. 
...
All the extreme outliers have in common that they mostly occur on a Friday and Saturdays.

## Your Best Story Pitch

### Task 7 (5 points)
Based on all the analyses performed, craft your best story pitch, including 
a headline and lede. Be sure to include what kinds of sources/people you'd talk 
to for the story.

Headline: 


Lede:  Accidents in Prince George's County are most likely to spike on Sundays, 
according to county level data from 2017 to April 2025 that tracked high accident counts.

Sources:

For this story, I would contact PGPD for comment on why Sundays, and what have
they've done to mitigate it. I would look at police reports to also understand 
the nature of the accidents. I would also check the traffic data to see what are
the busiest times during sunday, and have the police reports confirm it. 
