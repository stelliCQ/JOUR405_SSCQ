...
All the extreme outliers have in common that they mostly occur on a Friday and Saturdays in all the years that are recorded.
...
Lede:  Accidents in Prince George's County are most likely to spike on Sundays, according to county level data from 2017 to April 2025 that tracked high accident counts.

Sources:

For this story, I would contact PGPD for comment on why Sundays, and what have they've done to mitigate it. I would look at police reports to also understand the nature of the accidents. I would also check the traffic data to see what are the busiest times during sunday, and have the police reports confirm it. 
