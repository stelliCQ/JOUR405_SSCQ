...
Yes, I think there is a meaningful difference in the results. For example, there were more A's (20+), less C's (-20), and less F's (-10). Those are significant changes compared to the expected frequency.
...
Yes, we reject the null hypothesis. In this data, the chi-square 11.667 and the critical value is 9.4877. 
...
For A, we see an increase of 20+ when we compare the expected frequency vs. observed.
For B, we see an increase of 5+, when we compare the expected frequency vs. observed.
For C, we see a decrease of -20, when we compare the expected frequency vs. observed.
For D, we see a decrease of 5+, when we compare the expected frequency vs. observed. 
For F, we see a a decrease of -10, when we compare the expected frequency vs. observed. 

The notable discrepancies are A,C,and F. 

I would ask instructor:
a. Has there been a change in the assessments or grading policies in the past year?
b. Are there changes in the content of the classes?
